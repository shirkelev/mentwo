        ...
        return (
            <RootContainer>
                <SignUpContext.Provider value={{role, setRole, step, setStep, completed, setCompleted, form, setForm, saveSuccess}}>
                    ...
                    <ButtonSection>
                        {step > 0 ? <ButtonWrapper onClick={
                            step === 2 ? handleClickSave : handlePrev
                        } 
                            variant="contained" color="primary"  title={step === 2 ? 'Submit' : 'Prev'} to={null} /> : null}
                        {step < 2 ? <ButtonWrapper onClick={handleNext} variant="contained" color="primary" title='Next' to={null} /> : null}
                    </ButtonSection>
