...
export default function MentorFinishedPage ({user}) {
  const [message, setmessage] = useState(user.finishedMenteesData? '' : "You don't have any completed interviews yet");

  return (
    <div style={{ width: '100vw', height: '100vh' }}>
      <div style={{ padding: '10px'}}>
        <HomeContent headline = {Constants.FINISHED} list={user.finishedMenteesData ? user.finishedMenteesData : []} user={user}/>
        <IconWithMessage message={message} isVisible={user.finishedMenteesData}/>
